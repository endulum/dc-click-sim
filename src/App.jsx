...
export default function App() {
  ...
  return (
    <>
      ...
      <footer>
        <span>
          <b>Cave Catching Simulator</b>
          {' '}
          &copy; μ/endulum

        </span>
        <small><i>Test your reflexes by catching fake rares.</i></small>
        <a href="https://github.com/endulum/dc-click-sim">
          <img src={gh} alt="link to repository" aria-hidden="true" />
        </a>
      </footer>
    </>
